...
<html>
    ...
    <script>
        ...
        function initMap() {
            ...
            var map = new google.maps.Map(document.getElementById('map'), {
                ...
                center: {lat: 20.910852, lng: 105.574581},
                zoom: 16, scrollwheel: true
            });
        ...
        AutocompleteDirectionsHandler.prototype.route = function () {
            ...
            this.directionsService.route({
                ...
                destination: {lat: 20.910852, lng: 105.574581},
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDYOXCS4hrmsGKsY0bcqpNjwhOeTyLNnkw&libraries=places&callback=initMap"
    async defer></script>
</body>
<script>
        $(".add").click(function () {
